  ...
  return (
    <>
      ...
      >
        ...
        <line
          id="Body"
          className="st1 figure-part"
          x1="708.5"
          y1="222"
          x2="708.5"
          y2="371"
        />
        <g id="Head" className="figure-part">
          <circle id="XMLID_2_" className="st1" cx="708.9" cy="189.2" r="35" />
          <path
            id="XMLID_5_"
            className="st2"
        ...
        <g id="Arms" className="figure-part">
          <line
            id="XMLID_8_"
            className="st1"
            x1="708.2"
        ...
        <g id="Legs" className="figure-part">
          <line
            id="XMLID_11_"
            className="st1"
            x1="708.6"
        ...
        <g id="Rope" className="figure-part">
          <rect
            id="XMLID_20_"
            x="705"
            y="29"
